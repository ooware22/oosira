          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-[13px] font-medium transition-all duration-200 ${isActive
                      ...
                      <tbody className="divide-y divide-border/50">
                        {loading ? (
                          ...
                          <tr key={u.id} className="hover:bg-surface2/40 transition-colors">
                            ...
                            <td className="px-5 py-3.5">
                              <span className={`text-[11px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full ${u.plan === 'pro'
