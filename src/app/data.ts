...
export const candidates: Candidate[] = [
  {
    ...
    formations: [
      { diplome: 'Master', specialite: 'Genie Mecanique, Conception & Fabrication', etablissement: 'Universite Badji Mokhtar', ville: 'Annaba', annee: '2012', dateDebut: '2010-09', dateFin: '2012-06', mention: 'Tres Bien' },
    ...
    langues: [
      ...
      { langue: 'Francais', niveau: 'Courant', certification: 'TCF', score: 'C1' },
      { langue: 'Anglais', niveau: 'Intermediaire', certification: 'IELTS', score: '6.0' },
    ],
  ...
  },
  {
    ...
    formations: [
      { diplome: 'MBA', specialite: 'Management Commercial & Marketing', etablissement: 'ESC Alger', ville: 'Alger', annee: '2010', dateDebut: '2008-09', dateFin: '2010-06', mention: 'Major de promotion' },
  ...
  },
  {
    ...
    formations: [
      { diplome: 'Master', specialite: 'Comptabilite, Controle et Audit', etablissement: 'ESC Alger', ville: 'Alger', annee: '2014', dateDebut: '2012-09', dateFin: '2014-06', mention: 'Tres Bien' },
    ...
    langues: [
      { langue: 'Arabe', niveau: 'Natif' },
      { langue: 'Francais', niveau: 'Courant', certification: 'DELF', score: 'B2' },
      { langue: 'Anglais', niveau: 'Intermediaire' },
    ],
  ...
  },
  {
    ...
    formations: [
      { diplome: 'Master', specialite: 'Genie Logiciel & Systemes Distribues', etablissement: 'Universite USTO', ville: 'Oran', annee: '2017', dateDebut: '2015-09', dateFin: '2017-06', mention: 'Tres Bien' },
    ...
    langues: [
      { langue: 'Arabe', niveau: 'Natif' },
      { langue: 'Francais', niveau: 'Courant' },
      { langue: 'Anglais', niveau: 'Courant', certification: 'TOEFL iBT', score: '95/120' },
    ],
  ...
  },
  {
    ...
    formations: [
      { diplome: 'Diplome d\'Etat', specialite: 'Infirmiere de Sante Publique', etablissement: 'INFSPM', ville: 'Setif', annee: '2013', dateDebut: '2010-09', dateFin: '2013-06', mention: 'Tres Bien' },
